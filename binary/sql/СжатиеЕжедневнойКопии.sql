--exec msdb.dbo.RestoreDB 'D:\Backup\_ERP0_\Backup.bak', '_C1_ERP_COPY_YESTERDAY_ZIP', 'C1_ERP_0', 'C1_ERP_0_log'
--exec msdb.dbo.ClearData '_C1_ERP_COPY_YESTERDAY_ZIP' 
/*
use _C1_ERP_COPY_YESTERDAY_ZIP;
...
USE [master]
GO
ALTER DATABASE [_C1_ERP_COPY_YESTERDAY_ZIP] SET RECOVERY SIMPLE WITH NO_WAIT
GO
USE [_C1_ERP_COPY_YESTERDAY_ZIP];
GO
DBCC SHRINKFILE(C1_ERP_0_log, 0)
*/

/*
BACKUP DATABASE [_C1_ERP_COPY_YESTERDAY_ZIP] TO  
DISK = N'D:\Backup\_C1_ERP_COPY_YESTERDAY_ZIP.bak' WITH NOFORMAT, 
INIT,  
NAME = N'_C1_ERP_COPY_YESTERDAY_ZIP-Full Database Backup', 
SKIP, 
NOREWIND, 
NOUNLOAD, 
COMPRESSION,  
