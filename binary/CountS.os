...
//
//==============================================================
Функция ОбернутьВКавычки(Знач СтрокаДанных) Экспорт

	Возврат ?(Лев(СтрокаДанных, 1) = """" И Прав(СтрокаДанных, 1) = """", СтрокаДанных, """" + СтрокаДанных + """");
...
Функция СтрокаЗапускаКлиента()
	...
	Возврат  ?(ЭтоWindows, ОбернутьВКавычки(мНастройки.ПутьКлиентаАдминистрирования) + " ",  мНастройки.ПутьКлиентаАдминистрирования + " ");
...
Процедура ПолучитьНастройкиИзКоманднойСтроки()
	...
	Иначе	
		...
		ИмяИндексаElasticsearch			= "erp0"; 
		ИмяТипаElasticsearch			= "sessn1c"; 
