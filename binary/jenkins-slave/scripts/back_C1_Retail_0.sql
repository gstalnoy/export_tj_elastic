...
SET @pathname = 'C1_Retail_0';
SET @pathname = @pathname + @dt;
SET @pathname = @pathname + '.bak';

SET @phys_name = '\\dev0\Development\Backup\C1_Retail_0\' + @pathname;

PRINT N'Начало создания архива C1_Retail_0 ' + @phys_name;

EXEC sp_addumpdevice 'disk', 'networkdevice', @phys_name;

BACKUP DATABASE [C1_Retail_0] TO  
	networkdevice
	WITH COPY_ONLY, 
	NOINIT,  
	NAME = N' C1_Retail_0-Full Database Backup', 
	SKIP, 
	NOREWIND, 
	NOUNLOAD, 
	COMPRESSION, 
