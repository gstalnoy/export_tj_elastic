...
SET @pathname = '1C_BP_PR';
SET @pathname = @pathname + @dt;
SET @pathname = @pathname + '.bak';

SET @phys_name = '\\dev0\Development\Backup\1C.BP.PR\' + @pathname;

PRINT 'Start create arch 1C_BP_PR ' + @phys_name;

EXEC sp_addumpdevice 'disk', 'networkdevice', @phys_name;

BACKUP DATABASE [1C.BP.PR] TO  
	networkdevice
	WITH COPY_ONLY, 
	NOINIT,  
	NAME = N' 1C_BP_PR-Full Database Backup', 
	SKIP, 
	NOREWIND, 
	NOUNLOAD, 
	COMPRESSION, 
