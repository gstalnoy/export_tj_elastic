...
SET @pathname = '1C_BP_CNT';
SET @pathname = @pathname + @dt;
SET @pathname = @pathname + '.bak';

SET @phys_name = '\\dev0\Development\Backup\1C.BP.CNT\' + @pathname;

PRINT 'Start create arch 1C_BP_CNT ' + @phys_name;

EXEC sp_addumpdevice 'disk', 'networkdevice', @phys_name;

BACKUP DATABASE [1C.BP.CNT] TO  
	networkdevice
	WITH COPY_ONLY, 
	NOINIT,  
	NAME = N' 1C_BP_CNT-Full Database Backup', 
	SKIP, 
	NOREWIND, 
	NOUNLOAD, 
	COMPRESSION, 
